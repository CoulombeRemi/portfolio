                    ...
                    <div class="knobs">
                        <ul class="buttons">
                            <li>
                                <div class="button-label">
                                    <svg width="15" height="15" xmlns="http://www.w3.org/2000/svg">
                                        <g stroke-linecap="undefined" stroke-linejoin="undefined" stroke-opacity="null" stroke-width="null"
                                            stroke="#d1c8be" fill="none">
                                            <path d="M.47-.09v15.876M14.53-.404v15.877M7.594-.09v15.876M-1.217.47H7.47M16.78 14.593H7.406"
                                            />
                                        </g>
                                    </svg>
                                </div>
                            ...
                            <li>
                                <div class="button-label">
                                    <svg width="15" height="15" xmlns="http://www.w3.org/2000/svg">
                                        <g stroke-linecap="undefined" stroke-linejoin="undefined" stroke="#d1c8be" fill="none">
                                            <path d="M7.5.065L-.563 16.69M6.813-1.435l9 18.375" />
                                        </g>
                                    </svg>
                                </div>
                            ...
                            <li>
                                <div class="button-label">
                                    <svg width="15" height="15" xmlns="http://www.w3.org/2000/svg">
                                        ...
                                        <g>
                                            <title>Layer 1</title>
                                            <g fill="none" stroke="#d1c8be" stroke-linejoin="undefined" stroke-linecap="undefined">
                                                <path d="M14.542.645L.5 14.115" />
                                                <path stroke-width="null" stroke-opacity="null" d="M14.687.19V14M13.312-20.185l15 49.75"
                                                />
                                            </g>
                                        </g>
                                    </svg>
